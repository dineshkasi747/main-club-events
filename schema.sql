...
INSERT INTO `historical_events` (`id`, `clubId`, `academicYear`, `title`, `date`, `venue`, `description`, `volunteersCount`, `images`) VALUES (2301, 104, '2025-26', 'Git & GitHub Workshop', 'Sep 09, 2025', 'IBM Lab', 'A hands-on version control and collaborative platform workshop designed exclusively for students to understand branching, pull requests, and open source.', 15, '["https://images.unsplash.com/photo-1618401471353-b98aedd07871?w=500&auto=format&fit=crop"]');
INSERT INTO `historical_events` (`id`, `clubId`, `academicYear`, `title`, `date`, `venue`, `description`, `volunteersCount`, `images`) VALUES (2302, 104, '2025-26', 'Tool Wave AI Session', 'Sep 24, 2025', 'Main Auditorium', 'An interactive session exploring generative AI tools for code completion, image synthesis, and layout design acceleration.', 8, '["https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=500&auto=format&fit=crop"]');
